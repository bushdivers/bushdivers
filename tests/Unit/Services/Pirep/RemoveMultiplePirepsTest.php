...
class RemoveMultiplePirepsTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->removeMultiplePireps = $this->app->make(RemoveMultiplePireps::class);
    ...
    {
        $this->removeMultiplePireps->execute($this->pirep);
    ...
    public function test_multiple_pireps_removed()
    {
        ...
        $this->removeMultiplePireps->execute($pireps);
        $this->assertDatabaseMissing('pireps', ['id' => $this->pirep->id]);
    ...
    public function test_nothing_changed_if_aircraft_is_privately_owned()
    {
        $aircraft = Aircraft::factory()->create([
            'fleet_id' => $this->fleet->id,
            'fuel_onboard' => 50,
