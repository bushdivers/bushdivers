    ...
    <div>
      <div className="mt-4">
        <p>
          ...
          data controller we take all necessary steps to comply with the
          relevant Data Protection Acts and GDPR guidelines.
        </p>
        ...
        <p>
          ...
          visit, page views, website and navigation);
          <br />
          b) information that you provide to us for the purpose of registering
          as a pilot (including Full name, country of residence and email
          address); and
          <br />
        ...
        <p>
          ...
          <br />
          (d) send you general communications such notifications and news
          updates
          <br />
          (e) deal with enquiries and complaints made by or about you relating
          to the website.
        </p>
        ...
        <p>
          ...
          <br />
          Personal information including your name (first name and last
          initial); usernames for volanta and MSFS multiplayer; and your country
          of residence, is used on the pilot roster and public pilot profiles
          which are available to all visitors to this website.
        </p>
        ...
        <p>
          ...
          keeping your password and user details confidential.
        </p>
        ...
        <p>
          ...
          will require you to prove your identity with 2 pieces of approved
          photographic identification.) We will use reasonable efforts to
          supply, correct or delete personal information about you on our files.
        </p>
