...
import { Flex, Box, Image, Heading, Stat, StatLabel, StatNumber } from '@chakra-ui/react'
    ...
    <Flex direction="column">
        ...
        <Flex alignItems="center" direction="column">
          ...
          />
            <Box textAlign="center">
              <Heading size="2xl" my={4}>Welcome to Bush Divers VA</Heading>
              <Heading size="sm">Bush flying in and around Papua New Guinea and Alaska</Heading>
            </Box>
        </Flex>
      </Box>
      ...
      <Box style={{ backgroundImage: 'url(img/bg-2.jpg)' }}>
        <Box px={72} py={20} style={{ background: 'rgba(0,0,0,0.51)' }}>
          <Heading size="2xl" className="text-5xl">Our story</Heading>
