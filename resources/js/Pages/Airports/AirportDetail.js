          ...
          {airport.longest_runway_length && (
            <div className="rounded shadow p-4 mt-2 bg-white mx-2">
              <div className="flex items-center">
                ...
                <span>{airport.longest_runway_surface} {airport.longest_runway_length.toLocaleString(navigator.language)}ft x {airport.longest_runway_width}ft</span>
              </div>
            </div>
          )}
          <div className="rounded shadow p-4 mt-2 bg-white mx-2">
            ...
            <table className="mt-2 table table-auto table-condensed">
              ...
              {aircraft && aircraft.map((ac) => (
                <tr key={ac.id}>
                  ...
                  <td>{ac.hub_id}</td>
                  <td align="right">{ac.fuel_onboard.toLocaleString(navigator.language)}</td>
