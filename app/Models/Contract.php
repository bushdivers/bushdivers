    ...
    */
    ...
    protected function casts(): array
    {
        return [
            ...
            'is_custom' => 'boolean', // Custom contract, not generated by the system
            'is_shared' => 'boolean', // Shared contract - has been accepted but now available for all pilots
            'is_fuel' => 'boolean', // Fuel contract - no cargo, just fuel
            'is_paid' => 'boolean', // Paid contract - has been paid out, should match is_completed
        ];
    }
